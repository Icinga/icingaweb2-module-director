...
class DirectorDatalistEntryTest extends BaseTestCase
{
    ...
    public function testUnrestrictedEntryDoesNotNeedAnAuthenticatedUser(): void
    {
        // an unrestricted entry must not even ask who the current user is
        $this->assertTrue(DirectorDatalistEntry::isAllowedForCurrentUser(null));
        $this->assertTrue(DirectorDatalistEntry::isAllowedForCurrentUser(''));
    }
}
