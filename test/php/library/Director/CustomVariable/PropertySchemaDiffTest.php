...
class PropertySchemaDiffTest extends BaseTestCase
{
    ...
    public function testDetectsARenameAndADelete(): void
    {
        ...
        $this->assertFalse($rename->retyped);
    ...
    public function testARetypeIsDetected(): void
    {
        ...
        $this->assertTrue($retype->retyped, 'a retyped value only survives if it still fits the new type');
        $this->assertEquals('number', $retype->newType, 'the change must carry the type to check the value against');
    }
    ...
    public function testRenamePlusRetypeOnTheSameNodeClearsAtItsFinalKey(): void
    {
        ...
        $this->assertTrue($change->retyped, 'the old value only survives if it still fits the new type either way');
    }
    ...
    public function testRootRenameIsDetected(): void
    {
        ...
        $this->assertFalse($migration->retyped);
    ...
    public function testRootRetypeClearsTheWholeValue(): void
    {
        ...
        $this->assertTrue($migration->retyped);
        $this->assertEquals('dynamic-dictionary', $migration->newRootType);
