...
class NestedDictionaryItem extends FieldsetElement
{
     ...
     * @param array $property Stored child values, keyed by their own field name
     * @param int|string|null $entryKey This entry's own name in the dictionary
     *
     * @return array
     */
    public static function prepare(array $nestedItems, array $property, $entryKey = null): array
    {
        $nestedValues = [];
        ...
        if (is_string($entryKey) && str_starts_with($entryKey, NestedDictionary::UNDEFINED_KEY)) {
            $entryKey = null;
        }
