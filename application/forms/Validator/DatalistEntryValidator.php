...
/**
 * Validator to validate terms against a predefined list of datalist entries.
 */
class DatalistEntryValidator extends BaseValidator
{
    use Translation;

    /** @var ?array Datalist entries */
    private ?array $datalistEntries = null;

    /**
     * Sets the datalist entries.
     *
     * @param array $datalistEntries Datalist entries.
     *
     * @return $this
     */
