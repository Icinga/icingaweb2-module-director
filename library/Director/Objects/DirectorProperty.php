...
class DirectorProperty extends DbObject
{
    ...
    /**
     * @throws InvalidArgumentException if the key name is reserved for Director's internal use,
     *                                  a nested property is being stored with a value_type that
     *                                  may only be used at the top level, a dynamic-array is
     *                                  nested inside another dynamic-array, a 'sensitive' item
     *                                  type is used under a dynamic-array or datalist, or a
    ...
    {
        if ($this->get('key_name') === CustomVariables::RESERVED_OVERRIDE_HANDOFF_KEY) {
