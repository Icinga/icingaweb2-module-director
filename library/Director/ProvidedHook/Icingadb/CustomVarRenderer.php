...
class CustomVarRenderer extends CustomVarRendererHook
{
    ...
    /**
     * Clear everything learned about the last object rendered
     *
     * A renderer instance can get reused for a different object, so a stale
     * entry here could hide a value that isn't actually sensitive, or worse,
     * let a real secret through unmasked.
     *
     * @return void
     */
    private function resetObjectState(): void
    {
        $this->fieldConfig = [];
        $this->customVariableConfig = [];
        $this->datalistMaps = [];
        $this->dictionaryNames = [];
        $this->customPropertyDictionaries = [];
        $this->dictionaryChildConfig = [];
        $this->sensitiveArrayItems = [];
